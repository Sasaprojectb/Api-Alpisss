...
keymongodb = process.env.mongodb //example "mongodb+srv://Fahrozaa:Alifcahpasoan12#@custer1.o7grfuh.mongodb.net/?retryWrites=true&w=majority";
...
sendemail = fahrozabot.verifikasi@gmail.com //Email SMTP
fromsendemail = process.env.fromsendemail // From Email SMTP *kalau takde custom email kena sama email dengan Email SMTP
sendpwmail = dphpflgwdcbwmxhb // Password Email SMTP
domain = 'Alifafvedfahroza.site'// domain website tanpa http or https
